...
// ── Componente principal: tablero de evolución (sin fetch, solo presentación) ──
// Usado tanto por la vista interna (EvolucionClinica) como por la vista pública
// (EvolucionPublica), para que el paciente vea exactamente lo mismo que su nutricionista.
const EvolucionDashboard = ({ paciente, fichas, headerActions }) => {
...
export default EvolucionDashboard;
